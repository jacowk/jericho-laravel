...
/**
 * A test class for testing ViewObjectValidator
 *
 * @author Jaco Koekemoer
 * Date: 2016-12-05
 *
 */
class ViewObjectValidatorTest extends TestCase
{
	...
	public function testValidateWithValidObject()
	{
		...
		try
		{
			(new ViewObjectValidator())->validate($retrieved_account, "account", $account_id);
		}
		catch(Exception $e)
		{
