	...
	<div class="container">
		{{ Form::open(array('route' => array('do-update-title', $title->id), 'class' => 'form-horizontal')) }}
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					{{ Form::text('description', $title->description, array('class' => 'form-control captialize', 'placeholder' => 'Description')) }}
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					{{ Form::submit('Update Title', array('class' => 'btn btn-default')) }}
				</div>
			</div>
		{{ Form::close() }}
	</div>
