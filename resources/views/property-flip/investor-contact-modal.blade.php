<div id="investorContactModal{{ $investor_contact->contact_id }}" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<!-- Modal content-->
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Investor Contact Details</h4>
			</div>
			<div class="modal-body">
				<table class="table table-bordered table-striped table-condensed">
					<tr>
						<th class="col-sm-2 text-right">ID</th>
						<td>{{ $investor_contact->contact_id }}</td>						
					</tr>
					<tr>
						<th class="col-sm-2 text-right">Title</th>
						<td>{{ $investor_contact->contact_title }}</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>{{ $investor_contact->contact_home_tel_no }}</td>						
					</tr>
					<tr>
					...
					<tr>
						...
						<td>{{ $investor_contact->contact_fax_no }}</td>						
					</tr>
					<tr>
						<th class="col-sm-2 text-right">Personal Email</th>
						<td>{{ $investor_contact->contact_personal_email }}</td>						
					</tr>
					<tr>
