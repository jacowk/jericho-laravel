	...
	<div class="container">
		{{ Form::open(array('route' => array('do-update-milestone-type', $milestone_type->id), 'class' => 'form-horizontal')) }}
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					{{ Form::text('description', $milestone_type->description, array('class' => 'form-control captialize', 'placeholder' => 'Description')) }}
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					{{ Form::submit('Update Milestone Type', array('class' => 'btn btn-default')) }}
				</div>
			</div>
		{{ Form::close() }}
	</div>
