	...
	<div class="container">
		{{ Form::open(array('route' => array('do-update-permission', $permission->id), 'class' => 'form-horizontal')) }}
			...
			<div class="form-group">	
				...
				<div class="col-sm-10">
					{{ Form::text('name', $permission->name, array('class' => 'form-control captialize', 'placeholder' => 'Name')) }}
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					{{  Form::select('permission_type_id', $permission_types, $permission->permission_type_id, ['class' => 'form-control']) }}
				</div>
			</div>
