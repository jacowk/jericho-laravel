...
/**
 * This class is used to log audits against the investor_property_flip pivot table for deletions.
 * 
 * @author Jaco Koekemoer
 * Date: 2016-10-27
 *
 */
class DeleteInvestorPropertyFlipAuditor implements Auditor
{
	...
	{
		$new_audit = 'Deleted investor contact link from property flip (ID: ' . $this->property_flip->id . '):<br/>' .
