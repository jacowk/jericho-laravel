...
/**
 * This class is used to log audits against the estate_agent_property_flip pivot table for deletions.
 * 
 * @author Jaco Koekemoer
 * Date: 2016-10-27
 *
 */
class DeleteEstateAgentPropertyFlipAuditor implements Auditor
{
	public function __construct($request, $property_flip, $contact, $lookup_estate_agent_type_id, $user)
	{
	...
	private function buildNewAudit()
	{
		...
		$new_audit = 'Deleted estate agent contact link from property flip (ID: ' . $this->property_flip->id . '):<br/>' .
